				...
				<div className="g-row">
					<div className="g-col">
						...
						<div className="header-title-wrapper" onClick={this.navigateToHomePage}>
							<span className="content logo">Watch Party</span>
						</div>

						<ul className="header-actions">
							{this.renderSearchButton ( user.userName )}
							<li>
								<a title="Visit my portfolio site" href="https://gianmacaraeg.com/" target="_blank"
							...
							<li>
								<a title="Open this project on Github"
								   href="https://github.com/gfmacaraeg/Watch_Party"
